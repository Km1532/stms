...
class SchoolSchedule:
    ...
    def display_main_menu(self):
        ...
        print("13. Про нас")
        print("14. Про Школу/Ліцей")
        print("15. Вихід")
    
    def main_menu(self):
        while True:
            self.display_main_menu()
            choice = input("Введіть свій вибір (1-15): ")
            if choice == "1":
                ...
                print("Наша компанія займається цією програмою щоб вона помогла учням і вчителям дізнаватися Їх рлзклад оцінки і все інше що потрібно для школи.Якщо будуть якіймь питаня пошта:sandy.tuor.2024@gmail.com")
            elif choice == "14":
                print("Ліцей Імені Стіва Джобса — загальноосвітній навчальний заклад; гімназія в Івано-Франківську. Учасник Всеукраїнського конкурсу «100 найкращих шкіл України». За результатами ЗНО з української мови літератури в 2008, 2009 та у 2015 роках займала І місце серед шкіл України")
            elif choice == "15":
                print("Вихід з програми. До побачення!")
            break
        else:
            print("Невірний вибір. Будь ласка, введіть число від 1 до 15.")
